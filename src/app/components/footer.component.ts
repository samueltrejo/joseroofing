    ...
    <div class="container">
      <div class="row text-primary">
        ...
        <div class="col-md-3">
          ...
          <ul class="list-unstyled small">
            <li><a href="tel:+16155857127" role="button"><i class="bi bi-phone"></i> +1(615)585-7127</a></li>
            <li><a href="tel:+16158289974" role="button"><i class="bi bi-phone"></i> +1(615)828-9974 Español</a></li>
